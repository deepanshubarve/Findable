...
android {
    namespace = "com.example.findable"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.findable"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    //firebase dependency for Credential manager(oAuthlogin)
